...
User.destroy_all
cameron = User.create! email: 'cra212324234@columbia.edu', password: 'dog12345'
...
ques2 = Question.create! title: 'who is smart', text: 'is it cameron', user_id: jessie.id
...
ans2 = Answer.create! body: 'it is cameron', question_id: ques2.id, user_id: cameron.id
ans3 = Answer.create! body: 'do not trust sean', question_id: ques3.id, user_id: cameron.id
